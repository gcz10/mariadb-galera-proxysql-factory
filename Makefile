...
# fail-closed. Cialo bramki (sekrety + sondy + PASS) zyje w
# tests/lab/post-build-gate.sh (F4, code review) — tutaj zostaje tylko
# orkiestracja: straznik CLUSTER i TARGET_ENV dla sond.
lab-post-build-gate:  ## Bramka po budowie: wszystkie sondy stanu ustalonego, fail-closed
	$(cluster_guard)
	$(TARGET_ENV) tests/lab/post-build-gate.sh
