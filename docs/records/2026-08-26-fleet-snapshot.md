# Zdjęcie floty — zamrożone 2026-08-26

> **REKORD HISTORYCZNY. NIE AKTUALIZOWAĆ.**
> Ten plik był do 2026-08-26 `docs/infrastructure-state.md` i miał opisywać
> bieżący stan infrastruktury. Nie nadążał: ogłaszał jako aktywny stack `green`,
> którego maszyn nie było już od dwóch dni, i wyliczał najemców skasowanych
> tydzień wcześniej. Przyczyna jest strukturalna, nie redakcyjna — w tym repo
> klastry powstają i znikają w każdej sesji, więc ręcznie wpisane zdjęcie floty
> gnije szybciej, niż ktokolwiek je poprawia.
>
...
22 maszyny w puli `claude-isa`: 10 uruchomionych, 12 zatrzymanych.

| Zestaw | VMID | Stan |
|---|---|---|
| platforma `heliumv6` — `hmon`, `hp1`, `hp2`, `happ` | 9870-9873 | running |
| najemca `lyrav6-r9` — `l6g1`-`l6g3` | 9874-9876 | running |
| najemca `mirav6-r9` — `m6g1`-`m6g3` | 9877-9879 | running |
| platforma `shared` — `fcinfra`, `fcp1`, `fcp2`, `fcapp` | 9400-9403 | stopped |
| najemca `finalclaude-r10` — `f10g1`-`f10g3`, `f10r1` | 9410-9413 | stopped |
| najemca `newclaude17-r9` — `n17g1`-`n17g3`, `n17r1` | 9550-9553 | stopped |

Stack `green` (9750-9757) i cały stack v5 (`argonv5`, `lyrav5-r9`, `mirav5-r9`,
9860-9869) już nie istniały. W repo pozostało 20 definicji, z czego żywe były
trzy: jedna platforma i dwaj najemcy.

---

## Treść zachowana z 2026-08-24
