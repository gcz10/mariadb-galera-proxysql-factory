...
# newclaude17-r9 - warstwa BAZODANOWA siedmnastego przebiegu budowy od zera.
#
...
locals {
  ...
  gateway    = "192.168.1.1"
  # VMID 9550-9553 sa REUZYWANE po newclaude16-r9 (IP .144-.147 sa SWIEZE — aktywny skan 2026-08-22), ktory zostal
  ...
  # w calej flocie, a rozjazd nazw wykrylby zapomniany obiekt po n16.
  #
  ...
  vms = {
    n17g1 = { id = 9550, ip = 144, role = "galera", cpu = 2, ram = 3072, disk = 40 }
    n17g2 = { id = 9551, ip = 145, role = "galera", cpu = 2, ram = 3072, disk = 40 }
    n17g3 = { id = 9552, ip = 146, role = "galera", cpu = 2, ram = 3072, disk = 40 }
    n17r1 = { id = 9553, ip = 147, role = "restore", cpu = 1, ram = 2560, disk = 40 }
  }
}
...
module "vms" {
  ...
  tags               = ["rocky9", "galera", "newclaude17"]
  description_prefix = "newclaude17-r9 Rocky 9"
  description_dash   = "-"
...
output "shared_vip" {
  value = "192.168.1.139 (terraform/shared/)"
}
