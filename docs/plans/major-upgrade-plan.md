# Plan major upgrade: MariaDB 11.4.13 → 12.3 LTS
...
- **Obecna wersja:** MariaDB 11.4.13 (Galera 4, wsrep API 26)
...
2. **gcache.size** wystarczające dla IST (obecnie: 512M); zalecane >=2G na czas upgrade,
