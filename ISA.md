...
- ISC-33: PASS — bieżący runner zapisuje strumieniowy AES-256-GCM v3 (`GB3G`, nagłówek jako AAD, atomowa publikacja po weryfikacji tagu) i odczytuje v2/v1. Lokalny smoke odtworzył TAR 24 913 920 B z identycznym SHA-256 przy peak Python heap około 2,1 MB; kompatybilność v2/v1 oraz tamper/wrong-key pokrywają testy. Ostatni dowód live pozostaje historyczny; P1-B nie wdrażano na flotę 2026-09-04.
